...
import {
    ...
    MeshPhongMaterial, NoColors, Points,
...
class OBJLoader {
    constructor(manager) {
        ...
        this._object_pattern = /^[og]\s*(.+)?/;
        // mtllib file_reference
        this._material_library_pattern = /^mtllib /;
        // usemtl material_name
        this._material_use_pattern = /^usemtl /;
    ...
    parse(text) {
        ...
        for (var i = 0, l = lines.length; i < l; i++) {
            ...
            } else if ((result = this._object_pattern.exec(line)) !== null) {
                // o object_name
                // or
                // g group_name
            ...
            } else if (this._material_use_pattern.test(line)) {
                // material
                state.object.startMaterial(line.substring(7).trim(), state.materialLibraries);
            } else if (this._material_library_pattern.test(line)) {
                // mtl file
